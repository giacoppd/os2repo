...
\item 34e72bf was dominic, 2 days ago, message: Patch for submission
\item fe857be was dominic, 2 days ago, message: Fixed compiler errors. Really works now!
\item 7f621f8 was dominic, 2 days ago, message: can't type, also did some comment cleanup
\item 5e1ba82 was dominic, 2 days ago, message: Can't spell
\item 2fb44e8 was dominic, 2 days ago, message: Added some bits to enable the new io
\item bdfd252 was dominic, 2 days ago, message: Added the lines for the sstf bits
\item 50d36c3 was dominic, 2 days ago, message: Maybe this works for SSTF?
\item f5701ba was dominic, 3 days ago, message: More comments
\item 346b69a was dominic, 3 days ago, message: changed noop to sttf and left some thinking comments
\item fbc112e was dominic, 4 days ago, message: Initial thoughts on the assignment
\item f526adb was dominic, 4 days ago, message: Merge branch 'master' of https://github.com/giacoppd/os2repo
\item dd7db2b was dominic, 4 days ago, message: Added file for HW
\end{itemize}
\item
\textbf{Work Log}
